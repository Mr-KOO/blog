...
export class Contents extends React.Component {
            ...
            <div className={style.wrap}>
                <div className={style.container}>
                    ...
                    <div className={style.postBox}>
                        ...
                        <div>
                            <Link to="/about" className={style.aboutTxt}>
                                Read more...
                            </Link>
                        </div>
                                ...
                                <div className={style.optBtn}>
                                    ...
                                    <button className={style.storyOpt}>
                                        <svg width="19" height="19" viewBox="0 0 19 19">
                                            <path
                                                d="M4 7.331l6.032 6.67.495.547.495-.547 5.973-6.603-.989-.895-5.974 6.603h.99l-6.033-6.67z"
                                                fill-rule="evenodd">
                                            </path>
                                        </svg>
                                    </button>
    ...
    renderTitle(){
        return this.state.posts
            .filter((post, i) => i === 0 )
            .map((post, i) => <p key={'title-${i}'}>{ post.title }</p>)
    }

    renderImg(){
        return this.state.posts
            .filter((post, i) => i === 0 )
            .map((post, i) => <img key={'img-${i}'} src={ post.img }  className={ style.postImg} />)
    }
}
